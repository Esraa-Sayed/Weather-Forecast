...
class HourlyWeathersFavAdapter (private var context: Context, private var hours: List<Hourly>, private val language:String, private val tempUnit:String):
    RecyclerView.Adapter<HourlyWeathersFavAdapter.ViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.hourly_row_for_weather,parent,false)
